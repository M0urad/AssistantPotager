...
public class pageMeteo {
	...
	JLabel lblNewLabel_6 = new JLabel("" + meteo.valeurs.ventmoy.get(3).value + " km/h");
	...
	JLabel lblNewLabel_6_1 = new JLabel("" + meteo.valeurs.ventraf.get(3).value + " km/h");
	...
	JLabel lblNewLabel_6_2 = new JLabel("" + meteo.valeurs.nebu.get(3).value + "%");
	...
	JLabel lblNewLabel_6_3 = new JLabel("" + meteo.valeurs.humi.get(3).value + "%");
	...
	JLabel lblNewLabel_6_4 = new JLabel("" + (int)(meteo.valeurs.a.get(3).value-273.15) + "°C");
	...
	JLabel lblNewLabel_6_4_1 = new JLabel("" + (meteo.valeurs.pression.get(3).value/100) + " hPa");
	...
	JLabel lblNewLabelDemain = new JLabel("iconemeteo");
	lblNewLabelDemain.setBounds(10, 16, 99, 97);
	if (meteo.valeurs.nebu.get(8).value > 50) {
		lblNewLabelDemain.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/petitnuage99x97.png")));}
		else if (meteo.valeurs.humi.get(8).value > 50) {
			lblNewLabelDemain.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/nuagepluie99x97.png")));}
		else lblNewLabelDemain.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/soleil99x97.png")));
	weathereport_1.add(lblNewLabelDemain);
	...
	JLabel lblNewLabelApresDemain = new JLabel("iconemeteo");
	lblNewLabelApresDemain.setBounds(10, 16, 99, 97);
	if (meteo.valeurs.nebu.get(16).value > 50) {
		lblNewLabelApresDemain.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/petitnuage99x97.png")));}
		else if (meteo.valeurs.humi.get(16).value > 50) {
			lblNewLabelApresDemain.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/nuagepluie99x97.png")));}
		else lblNewLabelApresDemain.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/soleil99x97.png")));
	weathereport_1_1.add(lblNewLabelApresDemain);
	...
	JLabel lblNewLabelTroisJours = new JLabel("iconemeteo");
	lblNewLabelTroisJours.setBounds(10, 16, 99, 97);
	if (meteo.valeurs.nebu.get(24).value > 50) {
		lblNewLabelTroisJours.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/petitnuage99x97.png")));}
		else if (meteo.valeurs.humi.get(24).value > 50) {
			lblNewLabelTroisJours.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/nuagepluie99x97.png")));}
		else lblNewLabelTroisJours.setIcon(new ImageIcon(pageMeteo.class.getResource("/images/soleil99x97.png")));
	weathereport_1_2.add(lblNewLabelTroisJours);
